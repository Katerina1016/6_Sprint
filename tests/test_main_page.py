...
class TestMainPage:
    ...
    def test_click_on_scooter_logo(self, driver):
        ...
        assert current_url == Urls.BASE_PAGE and title_displayed
    ...
    def test_click_on_yandex_logo(self, driver):
        ...
        main_page.wait_navigating_url(Urls.YA_DZEN_URL)
    ...
    @pytest.mark.parametrize('questions_buts_locators, questions_text_locators, expected_question_text', zip(BasePageLocators.drop_down_lists_buttons, BasePageLocators.drop_down_lists_texts, DropDownListsTexts.expected_texts))
